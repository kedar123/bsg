...
class Admin::ExhibitionsUsersController < Admin::ApplicationController
	...
	def send_invitation
		...
		if QueuedMail.add( 'UserMailer',  'send_invoice_exhibition', [@current_object.user.profile.email_address,"invoice#{invoice.id}","An Invoice Is Sent To Your Email. Please Make The Payment by Login To This Account.",invoice, @current_object.user],0,true,@current_object.user.profile.email_address,"kedar.pathak@pragtech.co.in")
